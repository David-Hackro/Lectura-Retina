...
public class functionCapture {
	...
	**********************************************************************************************/
	ArrayList<Eye> capturing_process(boolean bDefaultParams, boolean bMultiple, boolean bProcessResult)
	{
		...
		IddkQualityMode qualityMode = new IddkQualityMode(IddkQualityMode.IDDK_QUALITY_VERY_HIGH);
			...
			*/
			...
			if(iRet.getValue() == IddkResult.IDDK_OK || iRet.getValue() == IddkResult.IDDK_SE_RIGHT_FRAME_UNQUALIFIED || iRet.getValue() == IddkResult.IDDK_SE_LEFT_FRAME_UNQUALIFIED)
			{
                ...
                else
                {
                	...
                	System.out.print("Quality of the current captured images:\n\t");
...
//			System.out.println("Your attached device can be accessed through: ");
//			option = Iddk2000Utils.display_menu(comm_methods, comm_methods.length, 0);
//			switch(option)
//			{
//			case -1:
//				/* User press Enter */
...
//			case 2:
//				/* UART */
//				config.setCommStd(IddkCommStd.IDDK_COMM_UART);
//				g_isUsbDevice = false;
//			}
	...
	*********************************************************************************************/
	ArrayList<Eye> get_result_image(int times)
	{
		
		ArrayList<Eye> eyesBytes = new ArrayList<>();
		...
		if(captureImage)
		{
			...
			else
			{
				...
				{
					System.out.println(eyeIdx);
					if(resultImage.get(eyeIdx) != null)
						eyesBytes.add(Iddk2000Utils.save_result_image(resultImage.get(eyeIdx), eyeSubtype[eyeIdx],""));
						
						//Iddk2000Utils.save_result_image(resultImage.get(eyeIdx), eyeSubtype[eyeIdx],"ojos David");
